        ...
        <div className="space-y-6">
          ...
          <Tabs defaultValue="expenses">
                    ...
                    <tbody>
                      {(expenses || []).map((e) => (
                        <tr key={e._id} className="border-b last:border-b-0">
                          <td className="py-2 pr-4">{e.name || e.category}</td>
                          <td className="py-2 pr-4">{e.category}</td>
                          <td className="py-2 pr-4 text-right">${Number(e.amount).toFixed(2)}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
            ...
            <TabsContent value="savings" className="space-y-6">
              ...
              {/* Table of savings names and tracked item */}
              <div className="mt-6 overflow-x-auto">
                <table className="min-w-full text-sm">
                  <thead>
                    <tr className="text-left border-b">
                  ...
                  <tbody>
                    {(savings || []).map((s) => (
                      <tr key={s._id} className="border-b last:border-b-0">
                        <td className="py-2 pr-4">{s.note || 'Saving'}</td>
                        <td className="py-2 pr-4">Saving</td>
                        <td className="py-2 pr-4 text-right">${Number(s.amount).toFixed(2)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <TabsContent value="investments" className="space-y-6">
              ...
              {/* Table of investment names and instruments */}
              <div className="mt-6 overflow-x-auto">
                <table className="min-w-full text-sm">
                  <thead>
                    <tr className="text-left border-b">
                  ...
                  <tbody>
                    {(investments || []).map((i) => (
                      <tr key={i._id} className="border-b last:border-b-0">
                        <td className="py-2 pr-4">{i.note || i.instrument}</td>
                        <td className="py-2 pr-4">{i.instrument}</td>
                        <td className="py-2 pr-4 text-right">${Number(i.amount).toFixed(2)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
